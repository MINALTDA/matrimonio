...
export const useTranslation = (namespace: string = 'common') => {
  // ✅ Cambiar 'locale' por 'language' que es lo que existe en el contexto
  ...
  useEffect(() => {
    const loadTranslations = async () => {
      try {
        setLoading(true)
        // ✅ Usar 'language' en lugar de 'locale'
    ...
    loadTranslations()
  }, [language, namespace]) // ✅ Cambiar dependencia de 'locale' a 'language'
  ...
  // ✅ Retornar 'language' en lugar de 'locale' para consistencia
