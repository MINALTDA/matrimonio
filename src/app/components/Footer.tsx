      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            <a
              href="#"
              className="flex items-center justify-center w-12 h-12 bg-accent rounded-full text-accent-foreground hover:bg-accent/90 transition-colors"
            ...
            <a
              href="mailto:ana.carlos@email.com"
              className="flex items-center justify-center w-12 h-12 bg-accent rounded-full text-accent-foreground hover:bg-accent/90 transition-colors"
              aria-label="E-mail"
            >
          ...
          <div className="border-t border-primary-foreground/20 pt-6">
            <p className="text-primary-foreground/60 text-sm">Feito com muito amor por MINA para nosso grande dia ❤️</p>
          </div>
        </div>
      </div>
    </footer>
